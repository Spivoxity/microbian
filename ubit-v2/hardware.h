...
#define SPI2_READY                      _REG(unsigned, 0x40023108)
#define SPI2_INTEN                      _REG(unsigned, 0x40023300)
#define SPI2_INTENSET                   _REG(unsigned, 0x40023304)
#define SPI2_INTENCLR                   _REG(unsigned, 0x40023308)
#define SPI2_ENABLE                     _REG(unsigned, 0x40023500)
#define SPI2_PSELSCK                    _REG(unsigned, 0x40023508)
#define SPI2_PSELMOSI                   _REG(unsigned, 0x4002350c)
#define SPI2_PSELMISO                   _REG(unsigned, 0x40023510)
#define SPI2_RXD                        _REG(unsigned, 0x40023518)
#define SPI2_TXD                        _REG(unsigned, 0x4002351c)
#define SPI2_FREQUENCY                  _REG(unsigned, 0x40023524)
#define SPI2_CONFIG                     _REG(unsigned, 0x40023554)
...
#define GPIO0 ((struct _gpio *) 0x50000500)
#define GPIO1 ((struct _gpio *) 0x50000800)
...
#define TIMER3 ((struct _timer *) 0x4001a000)
#define TIMER4 ((struct _timer *) 0x4001b000)
...
#define SPI2 ((struct _spi *) 0x40023000)
...
#define UARTE0 ((struct _uarte *) 0x40002000)
#define UARTE1 ((struct _uarte *) 0x40028000)
...
#define PWM0 ((struct _pwm *) 0x4001c000)
#define PWM1 ((struct _pwm *) 0x40021000)
#define PWM2 ((struct _pwm *) 0x40022000)
#define PWM3 ((struct _pwm *) 0x4002d000)
